...
/**
 * Created by liushuhua on 17-12-20.
 * 参照：http://www.jianshu.com/p/fe68506da6ff
...
public class ActivityManager {
    ...
    private ActivityManager getInstance() {
        if (instance == null) {
    ...
    private boolean checkForward(Context context) {
        ...
        try {
            ...
            LogUtils.e(TAG, "checkForward: " + "Warning!!! ApplicationContext");
